...
const ContactContainer = () => {
  ...
  useEffect(() => {
    const getContacts = async () => {
      const response = await apiClint.get(GET_DM_CONTACT_ROUTE, { withCredentials: true })
...
const Title = ({ text }) => {
  return (
    <h6 className="uppercase tracking-widesttex text-neutral-400 pl-10 font-light text-opacity-90 text-sm">
      {text}
    </h6>
  )
}
