...
const ProfileInfo = () => {
  ...
  const logout = async ()=>{
   try {
    const response = apiClint.post(LOGOUT_ROUTE,{},{withCredentials:true})
  ...
  return (
    <div className="absolute bottom-0 h-16 flex items-center justify-center px-10 w-full bg-[#2a2b33] gap-5">
