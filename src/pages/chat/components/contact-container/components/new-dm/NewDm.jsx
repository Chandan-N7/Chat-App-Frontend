...
const NewDm = () => {
    ...
    const { setSelectedChatType, setSelectedChatData, selectedChatMessages, closeChat, } = useAppStore()
    ...
    return (
        <>
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger>
                        <FaPlus className="text-neutral-400 font-light text-opacity-90 hover:text-neutral-100 cursor-pointer text-sm transition-all duration-300"
            ...
            <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal} >
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                   ...
                   { searchedContact.length > 0 &&(
                    ...
                    {
                        searchedContact.length <= 0 &&
                        <div className="flex-1  md:flex flex-col justify-center items-center mt-5 md:mt-5  duration-1000 transition-all">
                            <Lottie
